...
* **Docker화 및 CI/CD 자동 배포**: Synology Container Manager에서 Docker Compose를 통해 바로 기동할 수 있도록 Docker 설정을 완료하였으며, GitHub Release 시 GHCR 자동 빌드/푸시 및 패키지 10개 초과 시 오래된 버전 자동 삭제 파이프라인을 지원합니다.
