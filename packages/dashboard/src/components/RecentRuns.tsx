    ...
    <>
      ...
      >
        {isOpen ? (
          ...
          <div className="text-center py-4 text-xs text-neutral cursor-pointer hover:text-strong transition-colors" onClick={onToggle}>
            이력이 접혀 있습니다. 클릭하여 실행 결과를 확인하세요. (최근 {runs.length}건)
          </div>
        )}
      </SectionCard>
