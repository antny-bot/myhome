export const copy = {
  ko: {
    ...
    title: "실거래 집계",
    subtitle: "등록된 지역별 실거래 통계를 확인 및 관리하며, 매일 새벽 6시 이후 국토교통부 API로 신규 데이터가 자동 업데이트됩니다.",
    ...
    alertFailed: "실패",
    alertPrefix: "알림",
    dbStatsTitle: "실거래 로컬 DB 현황",
    dbStatsRegionCount: "수집 지역",
    dbStatsComplexCount: "등록 단지",
    dbStatsDealCount: "누적 실거래",
    dbStatsSubtitle: "국토교통부 OpenAPI 연동 및 로컬 SQLite 적재 현황",
